...
class TestMysql(BaseTest):
    def test_table_len_task1(self, prepare_table1):
    ...
    def test_table_len_task2(self, prepare_table2):
    ...
    def test_table_len_task3(self, prepare_table3):
    ...
    def test_table_len_task4(self, prepare_table4):
    ...
    def test_table_len_task5(self, prepare_table5):
